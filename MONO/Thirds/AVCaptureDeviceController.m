...
- (void)viewDidLoad {
    ...
    //模拟器
    UILabel *lb=[[UILabel alloc]initWithFrame:CGRectMake(SWIDTH/2-50, 100, 140, 30)];
    lb.text=@"请使用真机";
    ...
    output.rectOfInterest=CGRectMake(214/SHEIGHT, (SWIDTH-200)/2/SWIDTH, 200/SHEIGHT, 200/SWIDTH);
