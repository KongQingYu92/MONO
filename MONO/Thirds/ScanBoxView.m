...
{
    //设置二维码的扫描边框
    _boxView= [[UIView alloc] initWithFrame:CGRectMake(SWIDTH/2-100,180,200  ,200)];
    ...
    UILabel *lbContent=[[UILabel alloc]initWithFrame:CGRectMake(SWIDTH/2-150, 130, 300, 30)];
